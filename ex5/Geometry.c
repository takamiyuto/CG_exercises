...
void computeTriangleArea(Vector3 v1, Vector3 v2, Vector3 v3, float* result) {
    Vector3 v1v2, v1v3, cross;
    float norm;
    sub(v2, v1, &v1v2);
    sub(v3, v1, &v1v3);
    computeCrossProduct(v1v2, v1v3, &cross);
    computeNorm(cross, &norm);
    *result = 0.5f * norm;
}